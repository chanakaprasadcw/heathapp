...
const LoadingScreen = () => (
  <div className="fixed inset-0 bg-white z-[100] flex flex-col items-center justify-center">
    ...
    <div className="text-center mt-2">
      <h2 className="text-3xl font-bold text-slate-800 tracking-tight mb-1 font-['Poppins']">MediPulse</h2>
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-800 selection:bg-cyan-100 animate-fade-in">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex-shrink-0 flex items-center cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              ...
              <span className="font-bold text-2xl text-slate-900 tracking-tight font-['Poppins']">MediPulse</span>
            </div>
            ...
            <div className="hidden md:flex space-x-10 items-center">
              ...
              <button 
                ...
                className="bg-cyan-500 text-white px-7 py-3 rounded-full text-sm font-bold hover:bg-cyan-600 transition-all hover:shadow-lg transform hover:-translate-y-0.5 font-['Poppins']"
              >
                Download App
              </button>
            </div>
      ...
      <main className="pt-20">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <div className="lg:w-1/2 text-center lg:text-left z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 animate-fade-in" style={{animationDelay: '0.4s'}}>
                  <button className="flex items-center bg-slate-900 text-white px-6 py-3.5 rounded-xl hover:bg-slate-800 transition-all hover:scale-105 shadow-xl shadow-slate-900/10 min-w-[180px] justify-center group">
              ...
              <div className="lg:w-1/2 relative flex justify-center lg:justify-end animate-fade-in" style={{animationDelay: '0.4s'}}>
                ...
                {/* Phone Mockup */}
                <div className="relative mx-auto border-slate-800 bg-slate-800 border-[14px] rounded-[3.5rem] h-[650px] w-[320px] shadow-2xl">
                  ...
                  <div className="rounded-[2.5rem] overflow-hidden w-full h-full bg-white relative">
                    ...
                    <div className="bg-slate-50 h-full w-full overflow-y-auto scrollbar-hide pb-10 cursor-ns-resize">
                      ...
                      {/* App Header */}
                      <div className="bg-white p-6 pb-4 pt-12 sticky top-0 z-10 border-b border-slate-50 shadow-sm">
                        <div className="flex justify-between items-center mb-4">
                           <div className="flex items-center gap-2">
                              <MapPin size={16} className="text-cyan-500"/>
                              <span className="text-xs font-bold text-slate-700 font-['Poppins']">Colombo, Sri Lanka</span>
                           </div>
                           <div className="w-8 h-8 bg-slate-100 rounded-full overflow-hidden border border-slate-100">
                              <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah" alt="Profile" />
                           </div>
                        </div>
                        <div className="text-2xl font-bold text-slate-800 font-['Poppins']">Find your specialist</div>
                        
                        <div className="mt-4 relative">
                           <input type="text" placeholder="Search doctor, medicines..." className="w-full bg-slate-50 py-3 pl-10 pr-4 rounded-xl text-sm outline-none focus:ring-2 focus:ring-cyan-500/20 transition-all font-['Inter'] text-slate-600 placeholder-slate-400" />
                      ...
                      <div className="p-4 space-y-6">
                        ...
                        <div className="grid grid-cols-4 gap-2 text-center">
                           {[
                              {icon: <Stethoscope size={20}/>, label: "Doctor", color: "bg-cyan-50 text-cyan-600"},
                              {icon: <Pill size={20}/>, label: "Pharmacy", color: "bg-teal-50 text-teal-600"},
                              {icon: <Activity size={20}/>, label: "Hospital", color: "bg-blue-50 text-blue-600"},
                              {icon: <Video size={20}/>, label: "Consult", color: "bg-indigo-50 text-indigo-500"},
                           ].map((item, i) => (
                              <div key={i} className="flex flex-col items-center gap-2">
                                 <div className={`w-14 h-14 rounded-2xl flex items-center justify-center ${item.color} shadow-sm`}>
                                    {item.icon}
                                 </div>
                                 <span className="text-[10px] font-semibold text-slate-600 font-['Poppins']">{item.label}</span>
                              </div>
                           ))}
                        </div>
                        ...
                        <div>
                           <div className="flex justify-between items-center mb-3">
                              <h3 className="font-bold text-slate-800 font-['Poppins']">Top Doctors</h3>
                              <span className="text-cyan-600 text-xs font-bold font-['Poppins']">See All</span>
                           </div>
                           <div className="space-y-3">
                              {[
                                 ...
                                 <div key={i} className="bg-white p-3 rounded-2xl flex items-center gap-3 shadow-sm border border-slate-50">
                                    <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${doc.name}`} className="w-14 h-14 bg-slate-50 rounded-xl" alt="Doc" />
                                    <div className="flex-1">
                                       <div className="font-bold text-slate-800 text-sm font-['Poppins']">{doc.name}</div>
                                       <div className="text-xs text-slate-500 mb-1 font-['Inter']">{doc.spec}</div>
                         ...
                         {/* Banner */}
                         <div className="bg-gradient-to-r from-cyan-500 to-teal-400 rounded-2xl p-4 text-white relative overflow-hidden shadow-lg shadow-cyan-500/20">
                           <div className="relative z-10">
                              <div className="text-xs font-medium opacity-90 mb-1 font-['Poppins'] tracking-wide">EARLY PROTECTION</div>
                              <div className="font-bold text-lg mb-2 w-2/3 font-['Poppins']">Check your health regularly!</div>
                              <button className="bg-white text-cyan-600 px-4 py-1.5 rounded-lg text-xs font-bold font-['Poppins']">Check Now</button>
                           </div>
                           <div className="absolute right-0 bottom-0 w-24 h-24 bg-white/20 rounded-full translate-x-1/2 translate-y-1/2 blur-lg"></div>
                         </div>
                      </div>
                    </div>
                  </div>
           ...
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <RevealOnScroll>
                <div className="text-center mb-16 max-w-3xl mx-auto">
                   ...
                   <p className="text-3xl md:text-4xl font-bold text-slate-900 font-['Poppins']">Everything you need for a healthier life</p>
                   <p className="mt-4 text-slate-500 text-lg font-['Inter']">We bring together the best specialists, pharmacies, and diagnostic labs to provide a seamless healthcare experience.</p>
                </div>
              </RevealOnScroll>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                 ...
                 <RevealOnScroll delay={100}>
                    <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-cyan-100 hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 h-full">
                        <div className="w-14 h-14 bg-white border border-slate-100 rounded-2xl flex items-center justify-center mb-6 shadow-sm group-hover:bg-cyan-50 group-hover:border-cyan-200 transition-colors">
                            <Search className="w-7 h-7 text-cyan-500" />
                        </div>
                        <h3 className="text-xl font-bold text-slate-900 mb-3 font-['Poppins']">Find the Right Doctor Instantly</h3>
                        <p className="text-slate-600 text-sm leading-relaxed font-['Inter']">
                        Search by specialty, symptoms, or ratings and connect with the perfect doctor in seconds.
                        </p>
                    </div>
                 </RevealOnScroll>
                 ...
                 <RevealOnScroll delay={200}>
                    <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-cyan-100 hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 h-full">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3 font-['Poppins']">Book Appointments in One Tap</h3>
                        <p className="text-slate-600 text-sm leading-relaxed font-['Inter']">
                        Real-time schedules, instant confirmations, and smooth booking for online or in-clinic visits.
                        </p>
                    </div>
                 </RevealOnScroll>
                 ...
                 <RevealOnScroll delay={300}>
                    <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-cyan-100 hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 h-full">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3 font-['Poppins']">HD Video Consultations</h3>
                        <p className="text-slate-600 text-sm leading-relaxed font-['Inter']">
                        Secure, high-quality video calls so patients can receive expert care from anywhere.
                        </p>
                    </div>
                 </RevealOnScroll>
                 ...
                 <RevealOnScroll delay={100}>
                    <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-cyan-100 hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 h-full">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3 font-['Poppins']">All Health Records in One Place</h3>
                        <p className="text-slate-600 text-sm leading-relaxed font-['Inter']">
                        Prescriptions, lab reports, and medical history — securely organized for quick access.
                        </p>
                    </div>
                 </RevealOnScroll>
                 ...
                 <RevealOnScroll delay={200}>
                    <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-cyan-100 hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 h-full">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3 font-['Poppins']">Private Chat With Doctors</h3>
                        <p className="text-slate-600 text-sm leading-relaxed font-['Inter']">
                        Send messages, ask questions, and receive support directly from your doctor anytime.
                        </p>
                    </div>
                 </RevealOnScroll>
                 ...
                 <RevealOnScroll delay={300}>
                    <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-cyan-100 hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 h-full">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3 font-['Poppins']">Easy Schedule Management</h3>
                        <p className="text-slate-600 text-sm leading-relaxed font-['Inter']">
                        Flexible control to manage time slots, block hours, accept requests, and handle patient flow effortlessly.
                        </p>
                    </div>
                 </RevealOnScroll>
                 ...
                 <RevealOnScroll delay={100}>
                    <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-cyan-100 hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 h-full">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3 font-['Poppins']">Fast & Secure Payments</h3>
                        <p className="text-slate-600 text-sm leading-relaxed font-['Inter']">
                        Integrated online payments with automated billing, invoices, and earning analytics for doctors.
                        </p>
                    </div>
                 </RevealOnScroll>
                 ...
                 <RevealOnScroll delay={200}>
                    <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-cyan-100 hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 h-full">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3 font-['Poppins']">Verified Doctor Profiles</h3>
                        <p className="text-slate-600 text-sm leading-relaxed font-['Inter']">
                        Trusted profiles with verification badges, qualifications, experience, and patient reviews.
                        </p>
                    </div>
                 </RevealOnScroll>
                 ...
                 <RevealOnScroll delay={300}>
                    <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-cyan-100 hover:shadow-xl hover:shadow-cyan-500/5 transition-all duration-300 h-full">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3 font-['Poppins']">Real-Time Alerts & Reminders</h3>
                        <p className="text-slate-600 text-sm leading-relaxed font-['Inter']">
                        Stay updated with appointment reminders, status updates, and important health notifications.
                        </p>
                    </div>
                 </RevealOnScroll>
        ...
        <section id="interface" className="py-24 bg-slate-50 overflow-hidden relative border-y border-slate-100">
            {/* Background elements */}
                     ...
                     <RevealOnScroll delay={300} className="w-full flex justify-center">
                        <div className="relative w-full h-[500px] flex justify-center items-center">
                            ...
                            <div className="absolute top-0 right-0 md:right-10 w-64 bg-white rounded-3xl p-5 shadow-2xl shadow-slate-200 transform rotate-6 z-10 hover:rotate-0 transition-all duration-500 hover:scale-105 hover:z-30 cursor-pointer border border-slate-100">
                                ...
                                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Doctor2" className="w-20 h-20 bg-cyan-50 rounded-full mb-3" alt="Doc"/>
                                ...
                                <button className="w-full bg-cyan-500 text-white py-2 rounded-xl text-sm font-bold hover:bg-cyan-600 font-['Poppins']">Book Appointment</button>
                            </div>
        ...
        <section id="testimonials" className="py-24 bg-white">
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <RevealOnScroll>
                <h2 className="text-3xl font-bold text-center text-slate-900 mb-16 font-['Poppins']">Trusted by millions</h2>
              </RevealOnScroll>
                 ...
                 {[
                    ...
                    <RevealOnScroll key={i} delay={i * 150}>
                        ...
                        <div className="flex items-center">
                            <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${t.img}`} alt={t.name} className="w-10 h-10 rounded-full bg-slate-50 border border-slate-100" />
                            <div className="ml-3">
        ...
        {/* Download CTA */}
        <section id="download" className="py-24 bg-gradient-to-br from-teal-500 to-cyan-500 text-white overflow-hidden relative">
           ...
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
              <RevealOnScroll>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <button className="flex items-center bg-white text-teal-600 px-8 py-4 rounded-xl hover:bg-teal-50 transition-all hover:scale-105 min-w-[200px] justify-center shadow-lg">
                        <AppleLogo />
                        <div className="ml-3 text-left">
                    ...
                    <button className="flex items-center bg-teal-600/30 border border-white/40 text-white px-8 py-4 rounded-xl hover:bg-white/10 transition-all hover:scale-105 min-w-[200px] justify-center backdrop-blur-sm">
                        <PlayStoreLogo />
                        <div className="ml-3 text-left">
          ...
          <RevealOnScroll>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                <div className="col-span-2 md:col-span-1">
                    ...
                    <span className="font-bold text-xl text-slate-900 font-['Poppins']">MediPulse</span>
                    </div>
